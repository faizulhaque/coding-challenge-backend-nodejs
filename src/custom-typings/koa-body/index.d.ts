...
declare module 'koa-body' {
  namespace koaBody {
    ...
    interface IKoaBodyOptions {
      ...
      /**
       * {Function} Custom error handle, if throw an error,
       * you can customize the response - onError(error, context), default will throw
       */
  ...
  function koaBody(options?: koaBody.IKoaBodyOptions): any;
